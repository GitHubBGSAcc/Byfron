...
class Update():
    def __init__(self)
        self.version = '1.5.2'
        self.github = 'https://raw.githubusercontent.com/GitHubBGSAcc/Byfron/new/main/Data/Update.py'
        self.zipfile = 'https://github.com/GitHubBGSAcc/Byfron/archive/refs/heads/main.zip'
        self.update_checker()
    ...
    def update_checker(self):
        ...
        if "self.version = '1.5.2'" in code:
            ...
            if choice.lower() == 'y':
                ...
                with open("Byfron-main.zip", 'wb')as zipfile:
